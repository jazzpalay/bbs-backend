...
public class LogCommand {
    ...
    public static LogCommand toCommand(LogForm form, String userId) {
        return new LogCommand(userId,form.getTitle(), form.getContent(), form.getLogDate(), form.getTagIds());
    }
}
